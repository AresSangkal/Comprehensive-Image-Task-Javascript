(function ($) {
    $.fn.simplePaint = function (options) {
        var settings = $.extend({
            ...
            width: "500",
            height: "450",
            buttons: ["pen", "line", "triangle", "rect", "circle", "text", "eraser", "undo", "redo", "clear", "image", "save", "zoomIn", "zoomOut", "moveRight", "moveLeft", "moveUp", "moveDown"],
        ...
        var method = {
            ...
            init: function () {
                ...
                $('.simple-paint-file-input').change(function () {
                    ...
                    console.log(reader);
                    console.log('first image data',reader.result);
